...
# CONFIG
# -------------------------
INPUT_CSV = "data/prs_datasets/prs_karnataka_bills.csv"
OUTPUT_CSV = "data/prs_datasets/prs_karnataka_bills_processed.csv"
PARTIAL_CSV = "data/prs_datasets/prs_karnataka_bills_processed_partial.csv"
...
def main():
    ...
    final_df = final_df[final_df["bill_text"].str.len() > 0]
